...
[![Overview page](../../assets/images/entraID2.png){: style="height:70%;width:70%"}](../../assets/images/entraID2.png){: target="_blank" rel="noopener noreferrer"}
...
2. Add a description for your client secret, and select an expiration for the secret or specify a custom lifetime.
      ...
      [![Azure app registration](../../assets/images/entraID4.png){: style="height:70%;width:70%"}](../../assets/images/entraID4.png){: target="_blank" rel="noopener noreferrer"}

3. Click **Add**.
4. Record the client secret Value. This secret value is never displayed again after you leave the page.

      [![Azure app registration](../../assets/images/entraID5.png){: style="height:70%;width:70%"}](../../assets/images/entraID5.png){: target="_blank" rel="noopener noreferrer"}
...
2. At the top of the page, select **Add** next to **Application ID URI**.
      ...
      [![Azure app registration](../../assets/images/entraID3.png){: style="height:70%;width:70%"}](../../assets/images/entraID3.png){: target="_blank" rel="noopener noreferrer"}
...
4. Specify the scope's attributes in the **Add a scope** pane, and click **Add scope**.
      ...
      [![Azure app registration](../../assets/images/entraID6.png){: style="height:70%;width:70%"}](../../assets/images/entraID6.png){: target="_blank" rel="noopener noreferrer"}
...
[![Azure app registration](../../assets/images/entraID7.png){: style="height:70%;width:70%"}](../../assets/images/entraID7.png){: target="_blank" rel="noopener noreferrer"}
...
3. Select the **APIs my organization uses** tab, and then select the application from the list.
      ...
      [![Azure app registration](../../assets/images/entraID8.png){: style="height:70%;width:70%"}](../../assets/images/entraID8.png){: target="_blank" rel="noopener noreferrer"}

4. Under **Select permissions**, select the required scopes and click **Add permissions**.

      [![Azure app registration](../../assets/images/entraID9.png){: style="height:70%;width:70%"}](../../assets/images/entraID9.png){: target="_blank" rel="noopener noreferrer"}
...
6. In the **Grant admin consent confirmation** dialog, click **Yes**.
      ...
      [![Azure app registration](../../assets/images/entraID10.png){: style="height:70%;width:70%"}](../../assets/images/entraID10.png){: target="_blank" rel="noopener noreferrer"}
...
2. Search for and select the user account that you want to be an owner of the application.
      ...
      [![Azure app registration](../../assets/images/entraID11.png){: style="height:70%;width:70%"}](../../assets/images/entraID11.png){: target="_blank" rel="noopener noreferrer"}
...
4. On the **Settings** tab, make sure **Access token** is selected.
      ...
      [![Azure app registration](../../assets/images/entraID13.png){: style="height:70%;width:70%"}](../../assets/images/entraID13.png){: target="_blank" rel="noopener noreferrer"}
...
[![Azure app registration](../../assets/images/entraID14.png){: style="height:70%;width:70%"}](../../assets/images/entraID14.png){: target="_blank" rel="noopener noreferrer"}
...
4. Open the URL [http://localhost:8080/](http://localhost:8080/) and fill in the form details. You will find most of the values in the overview page of the Azure application registration. You should see a page like this:
    ...
    ![Azure app registration](../../assets/images/configuringAD-20.png){: style="height:60%;width:60%"}
...
![Azure app registration](../../assets/images/configuringAD-21.png){: style="height:60%;width:60%"}

Check the results:

![Azure app registration](../../assets/images/configuringAD-22.png){: style="height:60%;width:60%"}
