...
???+ info "v1.0.8 - What's new or changed"
    ...
    **New**
    ...
    - Added ability to view and revoke OAuth consents in the AdminUI via the [OAuth Consents](../references/usingdominorestapi/administrationui.md#oauth-consents) pane.
