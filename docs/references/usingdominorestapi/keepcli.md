...
To interact with Domino REST API:

1. Log in using the command `keep login` to authenticate your session.
2. Make API calls using the general syntax `keep HTTPKEYWORD urlpath`.
