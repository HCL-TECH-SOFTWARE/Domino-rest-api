...
!!! note
    ...
    The CORS update may affect logging in to and using the **Admin UI**. For more information on addressing the issue, see [Configure CORS for Admin UI, OAuth and your applications](../howto/install/cors.md). 
