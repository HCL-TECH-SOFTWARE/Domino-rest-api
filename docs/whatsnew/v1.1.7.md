...
- Added the console commands `tell restapi jfr start` for starting Java Flight Recorder (JFR) profiling and `tell restapi jfr stop` for stopping JFR profiling. For more information, see [Domino REST API task](../references/usingdominorestapi/restapitask.md).
